    ...
    <main className="min-h-screen bg-white pt-24 pb-20" data-testid="quickbooks-disconnected-page">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
          <p>
            Rent Ops no longer has access to this QuickBooks Online company. It will not read, create, or update any
            QuickBooks records until an administrator connects it again.
          </p>
          <p>
            Accounting records that were already brought into Rent Ops stay in Rent Ops. If you use Rent Ops accounting
