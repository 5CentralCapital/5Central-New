...
import { handleRentOpsMutationError, refreshRentOpsAfterConflict, sectionCreateAction } from "./ui";
...
function TenantDetail({ tenant, tab, onTab, onEdit, onChanged }: { onChanged: () => void; tenant: TenantView; tab: TenantTab; onTab: (tab: TenantTab) => void; onEdit: (action: QuickAction, values: FormValues) => void }) {
