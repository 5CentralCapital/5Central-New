...
import { DATE_MISSING_LABEL, DESCRIPTION_MISSING_LABEL, NAME_MISSING_LABEL, PROPERTY_MISSING_LABEL, STATUS_UNVERIFIED_LABEL, UNIT_MISSING_LABEL, UNKNOWN_AMOUNT_LABEL, UNKNOWN_COUNT_LABEL, UNVERIFIED_LABEL, CHARGE_TYPE_MISSING_LABEL, missingLabel } from "../../../../shared/review-cases/display-labels";
...
function formatCell(value: unknown, key: string, format?: string): string {
  ...
  if (Array.isArray(value)) return value.length ? value.map(title).join(", ") : absentCellLabel(key, format);
