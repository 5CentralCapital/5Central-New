...
function AuthenticatedWorkspace(){
 ...
 const views:Record<WorkspaceSection,()=>ReactNode>={
  ...
  'company-reports':()=><ReportingEntry identity={identity} organizationId={route.organizationId} reportId={route.reportId} presetId={route.presetId} onNavigate={(organizationId,reportId)=>go({...route,organizationId,reportId})} onOpenLegacy={report=>{if(REPORT_KEYS.includes(report as ReportKey))openReport(report as ReportKey);}}/>,
