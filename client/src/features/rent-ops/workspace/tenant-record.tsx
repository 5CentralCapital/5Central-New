...
export function TenantRecord({ tenant, snapshot, tab, onTab, onEdit, onChanged }: TenantRecordProps) {
  ...
  return <section className="rm-record-layout rm-tenant-record" aria-label={`Tenant record for ${summary.displayName}`}>
