...
export function PaymentEditDialog({id,tenantName,onClose,onSaved,tenancyId,businessDate}:{tenancyId?:string;businessDate?:string;id:string;tenantName:string;onClose:()=>void;onSaved:()=>Promise<void>}) {
