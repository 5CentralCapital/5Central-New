...
function callbackErrorMessage(code: string): string {
  switch (code) {
    case "session_expired": return "Your Rent Ops sign-in expired while QuickBooks was authorizing. Sign in again, then choose Connect QuickBooks.";
