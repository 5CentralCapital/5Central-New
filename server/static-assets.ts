...
interface ManifestChunk { file: string; imports?: string[]; css?: string[]; }
...
export function createPageShell(publicDir: string): (url: string) => string {
  ...
  const variants = {
    ops: hints(['src/pages/rent-ops.tsx','src/features/rent-ops/workspace/rm-workspace.tsx']),
    classic: hints(['src/pages/rent-ops.tsx','src/features/rent-ops/rent-ops-workspace.tsx']),
    tenant: hints(['src/pages/tenant-portal.tsx']),
