...
export class PostgresRentOpsRepository implements RentOpsRepository {
  ...
  async savePerson(value: RentOpsPerson): Promise<RentOpsPerson> { await this.upsert("rent_ops_people", ["id", "payment_review_reason", "payment_review_artifact_sha256", "payment_review_source_reference", "first_name", "last_name", "email", "phone", "phone_methods", "first_name_knowledge", "last_name_knowledge", "email_knowledge", "phone_knowledge", "renter_insurance_expires_on", "archived", "archived_knowledge", "source_system", "source_id"], [value.id, value.paymentReviewReason, value.paymentReviewArtifactSha256, value.paymentReviewSourceReference, value.firstName, value.lastName, value.email, value.phone, value.phoneMethods ? JSON.stringify(value.phoneMethods) : null, value.firstNameKnowledge, value.lastNameKnowledge, value.emailKnowledge, value.phoneKnowledge, value.renterInsuranceExpiresOn, value.archived, value.archivedKnowledge, value.source?.system, value.source?.sourceId]); return value; }
