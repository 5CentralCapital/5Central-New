...
export function serializeDepositLiabilityRow(value: unknown): JsonObject {
  ...
  return row(input, {
    ...
    personId: text(input, "personId"),
    tenantName: text(input, "tenantName"),
    securityHeldCents: number(input, "securityHeldCents"),
    refundablePetHeldCents: number(input, "refundablePetHeldCents"),
    otherRefundableHeldCents: number(input, "otherRefundableHeldCents"),
    totalHeldCents: number(input, "totalHeldCents"),
