...
if (process.env.NODE_ENV === "production") {
  throw new Error("5Central Ops demo entry is local-only and cannot run in production");
}
...
console.log(`5Central Ops demo server listening at http://127.0.0.1:${port}`);
