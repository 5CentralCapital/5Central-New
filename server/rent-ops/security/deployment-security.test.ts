...
test("security inventory matches all migration tables and repository runtime reads", () => {
  ...
  assert.deepEqual([...RENT_OPS_APPEND_ONLY_TABLES], ["accounting_qbo_named_observations", "accounting_qbo_binding_confirmations", "accounting_qbo_connection_events", "accounting_qbo_realm_bindings", "company_external_identities", "company_project_budget_lines", "company_investor_payment_sources", "company_investor_payment_allocations", "time_timesheet_revisions", "time_timesheet_deletion_tombstones", "time_timesheet_corrections", "time_review_events", "company_report_runs", "company_report_run_rows", "company_report_run_drilldowns", "company_report_exports", "company_report_preset_revisions", "company_report_package_revisions", "company_report_package_runs", "company_work_order_events", "company_review_case_events", "company_forecast_assumption_versions", "company_forecast_snapshots", "accounting_qbo_deletion_tombstones", "accounting_qbo_receivable_effects", "accounting_qbo_receivable_applications", "rent_ops_recurring_charge_schedules", "rent_ops_ledger_transactions", "rent_ops_payment_allocations", "rent_ops_activity_events", "rent_ops_record_changes", "rent_ops_payment_events", "rent_ops_billing_charges"]);
