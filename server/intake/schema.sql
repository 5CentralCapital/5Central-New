-- Candidate MRA/generic intake schema. Root integration registers this after
-- company foundation and the frozen investor/project chain. Application
-- startup never applies this file.
