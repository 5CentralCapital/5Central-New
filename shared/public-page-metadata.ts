...
export function normalizeSiteOrigin(value: string = CANONICAL_SITE_ORIGIN): string {
...
export function normalizeFaviconPath(value: string = DEFAULT_OG_IMAGE_PATH): string {
